...
│   └── tag.html          # Tag page
├── _plugins/
│   └── i18n_pages.rb     # Auto-generates per-language structural + taxonomy pages
├── _site/                 # Generated output (DO NOT EDIT)
├── assets/css/main.css   # Custom styles
├── en/                   # English (only about.md — structural pages are generated)
├── ja/                   # Japanese (only about.md)
├── ko/                   # Korean (only about.md)
...
Just use the category name in article front matter — the `_plugins/i18n_pages.rb` generator auto-discovers all categories and creates archive pages for every language at build time.

No manual file creation needed.

### Adding a New Tag

Just use the tag in article front matter — the generator auto-discovers all tags and creates archive pages for every language at build time.
...
| Categories | Auto-generated from article front matter | — |
| Tags | Auto-generated from article front matter | — |
...
4. Create `{lang}/about.md` (home, categories, and tags pages are auto-generated by the plugin)
